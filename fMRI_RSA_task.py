...
################# TEXTS #################
#########################################
welcome_txt = "You will see a series of letters and numbers\
\n presented in black, grey or color.\
\n\nYour task is to respond to 'targets':\
\nWhenever you see any NUMBER 1-9 and/or any GREY color,\
\nthen you must press the button with your RIGHT INDEX FINGER as fast as possible.\
...
\n(even when there are no letters or numbers).\
...
if subject_ID:
    ...
    # bids format
    output_filename = os.path.join(logfile_dir,'sub-{}_sess-{}_task-rsa_run-{}_events_{}.tsv'.format(subject_ID,session,run,timestr))
