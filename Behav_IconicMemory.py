...
cue_size        = 0.8 # PAPER 0.1 degrees of visual angle
...
endtrial_time         = 0.8 #0.05 #50ms, fix cross disappears here. 
...
if subject_ID:
    ...
    output_filename = os.path.join(logfile_dir,'IM_S{}_sess{}_{}.csv'.format(subject_ID,session,timestr))
    header = ['subject',
              'session',
              'letter_set',
              'trained',
