...
\nYour task is to passively view the symbols, you do not have to respond.\
\n\nMaintain eye-fixation at the center of the screen at all times (even when there are no symbols).\
...
if subject_ID:
    ...
    output_filename = os.path.join(logfile_dir,'Color_S{}_sess{}_run{}_{}.csv'.format(subject_ID,session,run,timestr))
    cols = ['subject',
              'session',
              'block',
              'condition',
